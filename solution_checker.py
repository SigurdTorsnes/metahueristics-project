...
def isFeasable(solution):
    ...
    for call in solution:
        if call == 0:
            ...
            package_size = data.call_info[call][2]
            ...
            if call not in picked_up:
                ...
                time += travel_time
                min_pickuptime = data.call_info[call][4]
                max_pickuptime = data.call_info[call][5]
                ...
                min_deliverytime = data.call_info[call][6]
                max_deliverytime = data.call_info[call][7]
...
def cost_insert(sol,call,index,vehicle_index):
    ...
    if call_before == 0:
        ...
        node_before = data.call_info[call_before][1]
    else:
        node_before = data.call_info[call_before][0]

    ti = data.num_vehicles*((node_before-1)*data.num_nodes+cur_node)-data.num_vehicles+vehicle_index
    travel_cost = data.travel_cost[ti]
    ...
    if call_after == 0:
        ...
        node_after = data.call_info[call_after][1]
    else:
        node_after = data.call_info[call_after][0]
